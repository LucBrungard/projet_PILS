...
class GuiPart:
    def __init__(self, master, tortue, queue, endCommand):
        ...
        self.interface = InterfaceV(master, tortue)
    ...
    def bind_commands(self) :
        self.interface.bind_command(self.avance, "AVANCE (.*)")
        self.interface.bind_command(self.recule, "RECULE (.*)")
        self.interface.bind_command(self.tourneDroite, "TOURNEDROITE (.*)")
        self.interface.bind_command(self.tourneGauche, "TOURNEGAUCHE (.*)")
        self.interface.bind_command(self.leveCrayon, "LEVECRAYON")
        self.interface.bind_command(self.baisseCrayon, "BAISSECRAYON")
        self.interface.bind_command(self.restaure, "RESTAURE")
        self.interface.bind_command(self.nettoie, "NETTOIE")
        self.interface.bind_command(self.origine, "ORIGINE")
        self.interface.bind_command(self.fpos, "FPOS (.*) (.*)")
        self.interface.bind_command(self.fcc, "FCC (.*) (.*) (.*)")
